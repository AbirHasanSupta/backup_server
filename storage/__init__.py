"""Storage package: High-performance filesystem CAS and S3 object storage provider.

Exports both legacy storage utility functions and the new StorageBackend interface.
"""
...
def _resolve_device_folder(device_id: str) -> str:
    ...
    if _get_device_folder_name is None:
        try:
            ...
            _get_device_folder_name = lambda did: None
